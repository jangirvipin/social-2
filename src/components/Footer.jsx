...
const footerLinks = {
  services: [
    ...
    { name: 'SEO & Organic Growth', path: '/services' },
    { name: 'Paid Ads Management', path: '/services' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-slate-400 text-sm max-w-xs">
              We help businesses grow through strategic digital marketing, creative branding, and data-driven campaigns.
            </p>
            <div className="flex gap-4 mt-6">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href="#"
                  className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center text-slate-400 hover:bg-amber-500 hover:text-black transition-colors"
                >
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-sm">
            © {new Date().getFullYear()} ApexDigital. All rights reserved.
          </p>
